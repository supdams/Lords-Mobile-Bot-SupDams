    ...
    internal static string ReadServiceId()
    {
      ...
      using (AndroidJavaClass androidJavaClass = new AndroidJavaClass("com.unity3d.player.UnityPlayer"))
      {
        using (AndroidJavaObject androidJavaObject = androidJavaClass.GetStatic<AndroidJavaObject>("currentActivity"))
        {
          ...
          string str2 = androidJavaObject.Call<AndroidJavaObject>("getPackageManager").Call<AndroidJavaObject>("getApplicationInfo", (object) str1, (object) 128).Get<AndroidJavaObject>("metaData").Call<string>("getString", (object) "com.google.android.gms.nearby.connection.SERVICE_ID");
