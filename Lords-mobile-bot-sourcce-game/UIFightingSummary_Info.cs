...
#nullable disable
public class UIFightingSummary_Info : 
  GUIWindow,
  IUpDateScrollPanel,
  ...
  IUIButtonDownUpHandler
{
  ...
  public void SetFsData(bool bopen = true)
  {
    ...
    this.IsAttack = this.DM.mFs_Side == (byte) 0 || this.DM.mFs_Side == (byte) 2 || this.DM.mFs_Side == (byte) 4 || this.DM.mFs_Side == (byte) 6;
    ...
    this.tmplistInfo_Data_Icon.Add(byte.MaxValue);
    this.tmplist.Add(44f);
    if (this.DM.mFS_DetailData.HasSeigeData == (byte) 1)
      this.tmplistInfo_Type.Add((byte) 2);
    else
      this.tmplistInfo_Type.Add((byte) 3);
    if (this.IsAttack && (this.DM.mFs_Side == (byte) 0 || this.DM.mFs_Side == (byte) 4))
    ...
    if (this.DM.mFS_DetailData.mFS_Hero[0].HeroNum > (byte) 0)
    {
      ...
      this.tmplistInfo_Data_.Add(0U);
      this.tmplistInfo_Data_Icon.Add(byte.MaxValue);
      for (int index = 0; index < (int) this.DM.mFS_DetailData.mFS_Hero[0].HeroNum; ++index)
      {
        this.mHeroID_A[index] = this.DM.mFS_DetailData.mFS_Hero[0].HeroID[index];
        this.mHeroRank_A[index] = this.DM.mFS_DetailData.mFS_Hero[0].Rank[index];
        this.mHeroStar_A[index] = this.DM.mFS_DetailData.mFS_Hero[0].Star[index];
      }
    ...
    for (int index3 = 0; index3 < 16; ++index3)
    {
      ...
      if (((int) this.DM.mFS_DetailData.mFS_Info[0].TroopsFlag >> index4 & 1) == 1)
      {
        ++this.tmpA;
        this.tmplistInfo_Type.Add((byte) 9);
        this.tmpSD = this.DM.SoldierDataTable.GetRecordByKey((ushort) (index4 + 1));
        this.tmplistInfo_DataName.Add(this.DM.mStringTable.GetStringByID((uint) this.tmpSD.Name));
        this.tmplistInfo_Data_L.Add(this.DM.mFS_DetailData.mFS_Info[0].Troops_L[index4]);
        this.tmplistInfo_Data_H.Add(this.DM.mFS_DetailData.mFS_Info[0].Troops_H[index4]);
        this.tmplistInfo_Data_D.Add(this.DM.mFS_DetailData.mFS_Info[0].Troops_D[index4]);
        this.tmplistInfo_Data_.Add(0U);
    ...
    if (!bopen || this.DM.mFs_A_Count > (byte) 0)
    {
      for (int index5 = 0; index5 < (int) this.DM.mFs_A_Count; ++index5)
      {
        if (this.DM.mFS_DetailData.HasSeigeData == (byte) 1)
          this.tmplistInfo_Type.Add((byte) 2);
        else
        ...
        this.Cstr_PlayName[1].Append(this.DM.mFs_Info_A[index5].Name);
        if (DataManager.CompareStr(this.Cstr_PlayName[0], this.Cstr_PlayName[1]) == 0 && this.IsAttack && (this.DM.mFs_Side == (byte) 2 || this.DM.mFs_Side == (byte) 6))
          this.tmplistInfo_DataName.Add(this.DM.mStringTable.GetStringByID(5338U));
        else
          this.tmplistInfo_DataName.Add(this.DM.mFs_Info_A[index5].Name.ToString());
        this.tmplistInfo_Data_L.Add(this.DM.mFs_Info_A[index5].Troops);
        this.tmplistInfo_Data_H.Add(this.DM.mFs_Info_A[index5].Traps);
        this.tmplistInfo_Data_D.Add(0U);
        this.tmplistInfo_Data_.Add(0U);
        this.tmplistInfo_Data_Icon.Add(byte.MaxValue);
        this.tmplist.Add(59f);
        ...
        {
          int index7 = 3 - index6 / 4 + index6 % 4 * 4;
          if (((int) this.DM.mFs_Info_A[index5].TroopsFlag >> index7 & 1) == 1)
          {
            ++num;
            this.tmplistInfo_Type.Add((byte) 9);
            this.tmpSD = this.DM.SoldierDataTable.GetRecordByKey((ushort) (index7 + 1));
            this.tmplistInfo_DataName.Add(this.DM.mStringTable.GetStringByID((uint) this.tmpSD.Name));
            this.tmplistInfo_Data_L.Add(this.DM.mFs_Info_A[index5].Troops_L[index7]);
            this.tmplistInfo_Data_H.Add(this.DM.mFs_Info_A[index5].Troops_H[index7]);
            this.tmplistInfo_Data_D.Add(this.DM.mFs_Info_A[index5].Troops_D[index7]);
            this.tmplistInfo_Data_.Add(0U);
            this.tmplistInfo_Data_Icon.Add((byte) index7);
            this.tmplist.Add(35f);
          }
        }
        if (num > 0)
    ...
    this.tmplist.Add(44f);
    this.tmplistInfo_Type.Add((byte) 3);
    if (!this.IsAttack && (this.DM.mFs_Side == (byte) 1 || this.DM.mFs_Side == (byte) 5))
      this.tmplistInfo_DataName.Add(this.DM.mStringTable.GetStringByID(5338U));
    else
    ...
    this.tmplistInfo_Data_Icon.Add(byte.MaxValue);
    this.tmplist.Add(59f);
    if (this.DM.mFS_DetailData.mFS_Hero[1].HeroNum > (byte) 0)
    {
      ...
      this.tmplistInfo_Data_.Add(0U);
      this.tmplistInfo_Data_Icon.Add(byte.MaxValue);
      for (int index = 0; index < (int) this.DM.mFS_DetailData.mFS_Hero[1].HeroNum; ++index)
      {
        this.mHeroID_D[index] = this.DM.mFS_DetailData.mFS_Hero[1].HeroID[index];
        this.mHeroRank_D[index] = this.DM.mFS_DetailData.mFS_Hero[1].Rank[index];
        this.mHeroStar_D[index] = this.DM.mFS_DetailData.mFS_Hero[1].Star[index];
      }
      this.tmplist.Add(96f);
    }
    ...
    {
      int index9 = 3 - index8 / 4 + index8 % 4 * 4;
      if (((int) this.DM.mFS_DetailData.mFS_Info[1].TroopsFlag >> index9 & 1) == 1)
      {
        ++this.tmpA;
        this.tmplistInfo_Type.Add((byte) 10);
        this.tmpSD = this.DM.SoldierDataTable.GetRecordByKey((ushort) (index9 + 1));
        this.tmplistInfo_DataName.Add(this.DM.mStringTable.GetStringByID((uint) this.tmpSD.Name));
        this.tmplistInfo_Data_L.Add(this.DM.mFS_DetailData.mFS_Info[1].Troops_L[index9]);
        this.tmplistInfo_Data_H.Add(this.DM.mFS_DetailData.mFS_Info[1].Troops_H[index9]);
        this.tmplistInfo_Data_D.Add(this.DM.mFS_DetailData.mFS_Info[1].Troops_D[index9]);
        this.tmplistInfo_Data_.Add(0U);
        this.tmplistInfo_Data_Icon.Add((byte) index9);
        this.tmplist.Add(35f);
      }
    }
    if (this.tmpA > (byte) 0)
    ...
    if (this.DM.mFS_DetailData.HasSeigeData == (byte) 1)
    {
      this.tmplistInfo_Type.Add((byte) 4);
      ...
      {
        int index11 = 3 - index10 / 3 + index10 % 3 * 4;
        if (((int) this.DM.mFS_DetailData.TrapsFlag >> index11 & 1) == 1)
        {
          ++this.tmpA;
          this.tmplistInfo_Type.Add((byte) 10);
          this.tmpSD = this.DM.SoldierDataTable.GetRecordByKey((ushort) (index11 + 17));
          this.tmplistInfo_DataName.Add(this.DM.mStringTable.GetStringByID((uint) this.tmpSD.Name));
          this.tmplistInfo_Data_L.Add(this.DM.mFS_DetailData.mTraps_L[index11]);
          this.tmplistInfo_Data_H.Add(this.DM.mFS_DetailData.mTraps_S[index11]);
          this.tmplistInfo_Data_D.Add(this.DM.mFS_DetailData.mTraps_D[index11]);
          this.tmplistInfo_Data_.Add(0U);
          this.tmplistInfo_Data_Icon.Add((byte) (index11 + 16));
          this.tmplist.Add(35f);
        }
      }
      if (this.tmpA > (byte) 0)
    ...
    if (!bopen || this.DM.mFs_D_Count > (byte) 0)
    {
      for (int index12 = 0; index12 < (int) this.DM.mFs_D_Count; ++index12)
      {
        this.Cstr_PlayName[1].ClearString();
        this.Cstr_PlayName[1].Append(this.DM.mFs_Info_D[index12].Name);
        this.tmplistInfo_Type.Add((byte) 3);
        if (DataManager.CompareStr(this.Cstr_PlayName[0], this.Cstr_PlayName[1]) == 0 && !this.IsAttack && this.DM.mFs_Side == (byte) 3)
          this.tmplistInfo_DataName.Add(this.DM.mStringTable.GetStringByID(5338U));
        else
          this.tmplistInfo_DataName.Add(this.DM.mFs_Info_D[index12].Name.ToString());
        this.tmplistInfo_Data_L.Add(this.DM.mFs_Info_D[index12].Troops);
        this.tmplistInfo_Data_H.Add(this.DM.mFs_Info_D[index12].Traps);
        this.tmplistInfo_Data_D.Add(0U);
        this.tmplistInfo_Data_.Add(0U);
        this.tmplistInfo_Data_Icon.Add(byte.MaxValue);
        this.tmplist.Add(59f);
        ...
        {
          int index14 = 3 - index13 / 4 + index13 % 4 * 4;
          if (((int) this.DM.mFs_Info_D[index12].TroopsFlag >> index14 & 1) == 1)
          {
            ++num;
            this.tmplistInfo_Type.Add((byte) 10);
            this.tmpSD = this.DM.SoldierDataTable.GetRecordByKey((ushort) (index14 + 1));
            this.tmplistInfo_DataName.Add(this.DM.mStringTable.GetStringByID((uint) this.tmpSD.Name));
            this.tmplistInfo_Data_L.Add(this.DM.mFs_Info_D[index12].Troops_L[index14]);
            this.tmplistInfo_Data_H.Add(this.DM.mFs_Info_D[index12].Troops_H[index14]);
            this.tmplistInfo_Data_D.Add(this.DM.mFs_Info_D[index12].Troops_D[index14]);
            this.tmplistInfo_Data_.Add(0U);
            this.tmplistInfo_Data_Icon.Add((byte) index14);
            this.tmplist.Add(35f);
          }
        }
        if (num > 0)
  ...
  public void UpDateRowItem(GameObject item, int dataIdx, int panelObjectIdx, int panelId)
  {
    ...
    switch (this.tmplistInfo_Type[dataIdx])
    {
      ...
      case 7:
        ...
        if (this.DM.mFs_Main[0] == (byte) 1 && this.DM.mFs_A_MHIdx != (byte) 5)
        {
          this.Img_MainHeroShow1[(int) this.DM.mFs_A_MHIdx] = ((Component) this.mSeroll_Item[panelObjectIdx]).transform.GetChild(num - 1).GetChild((int) this.DM.mFs_A_MHIdx).GetChild(3).GetComponent<Image>();
          ((Component) this.Img_MainHeroShow1[(int) this.DM.mFs_A_MHIdx]).gameObject.SetActive(true);
          this.Img_MainHeroShow_A[(int) this.DM.mFs_A_MHIdx] = ((Component) this.mSeroll_Item[panelObjectIdx]).transform.GetChild(num - 1).GetChild((int) this.DM.mFs_A_MHIdx).GetChild(3).GetChild(0).GetComponent<Image>();
        ...
        for (int heroNum = (int) this.DM.mFS_DetailData.mFS_Hero[0].HeroNum; heroNum < 5; ++heroNum)
          ((Component) this.mSeroll_Item[panelObjectIdx]).transform.GetChild(num - 1).GetChild(heroNum).gameObject.SetActive(false);
        break;
      case 8:
        this.mSeroll_Item[panelObjectIdx].m_BtnID2 = 5;
        num = 5;
        this.Img_HeroBG[panelObjectIdx].sprite = this.IsAttack ? this.SArray.m_Sprites[1] : this.SArray.m_Sprites[0];
        if (this.DM.mFs_Main[1] == (byte) 1 && this.DM.mFs_D_MHIdx != (byte) 5)
        {
          this.Img_MainHeroShow2[(int) this.DM.mFs_D_MHIdx] = ((Component) this.mSeroll_Item[panelObjectIdx]).transform.GetChild(num - 1).GetChild((int) this.DM.mFs_D_MHIdx).GetChild(3).GetComponent<Image>();
          ((Component) this.Img_MainHeroShow2[(int) this.DM.mFs_D_MHIdx]).gameObject.SetActive(true);
          this.Img_MainHeroShow_D[(int) this.DM.mFs_D_MHIdx] = ((Component) this.mSeroll_Item[panelObjectIdx]).transform.GetChild(num - 1).GetChild((int) this.DM.mFs_D_MHIdx).GetChild(3).GetChild(0).GetComponent<Image>();
        ...
        for (int heroNum = (int) this.DM.mFS_DetailData.mFS_Hero[1].HeroNum; heroNum < 5; ++heroNum)
          ((Component) this.mSeroll_Item[panelObjectIdx]).transform.GetChild(num - 1).GetChild(heroNum).gameObject.SetActive(false);
        break;
      case 9:
  ...
  public float AddAttPlayer(float ftmpH, bool bAdd = false, byte mNum = 0) => 0.0f;

  public float Add_DPlayer(float ftmpH, bool bAdd = false, byte mNum = 0) => 0.0f;
  ...
  private void Update()
  {
    if (this.DM.mFs_A_MHIdx != (byte) 5 && (Object) this.Img_MainHeroShow1[(int) this.DM.mFs_A_MHIdx] != (Object) null && (Object) this.Img_MainHeroShow_A[(int) this.DM.mFs_A_MHIdx] != (Object) null && ((Component) this.Img_MainHeroShow1[(int) this.DM.mFs_A_MHIdx]).gameObject.activeSelf)
    {
      ...
      if ((double) this.ShowMainHeroTime1 >= 0.0)
      {
        if ((double) this.ShowMainHeroTime1 >= 2.0)
          this.ShowMainHeroTime1 = 0.0f;
        ((Graphic) this.Img_MainHeroShow_A[(int) this.DM.mFs_A_MHIdx]).color = new Color(1f, 1f, 1f, (double) this.ShowMainHeroTime1 <= 1.0 ? this.ShowMainHeroTime1 : 2f - this.ShowMainHeroTime1);
      }
    }
    if (this.DM.mFs_D_MHIdx == (byte) 5 || !((Object) this.Img_MainHeroShow2[(int) this.DM.mFs_D_MHIdx] != (Object) null) || !((Object) this.Img_MainHeroShow_D[(int) this.DM.mFs_D_MHIdx] != (Object) null) || !((Component) this.Img_MainHeroShow2[(int) this.DM.mFs_D_MHIdx]).gameObject.activeSelf)
      return;
    ...
    if ((double) this.ShowMainHeroTime2 >= 2.0)
      this.ShowMainHeroTime2 = 0.0f;
    ((Graphic) this.Img_MainHeroShow_D[(int) this.DM.mFs_D_MHIdx]).color = new Color(1f, 1f, 1f, (double) this.ShowMainHeroTime2 <= 1.0 ? this.ShowMainHeroTime2 : 2f - this.ShowMainHeroTime2);
  }
}
