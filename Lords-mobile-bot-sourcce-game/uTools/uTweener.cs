...
namespace uTools
{
  public abstract class uTweener : MonoBehaviour
  {
    ...
    public void Sample(float _factor, bool _isFinished)
    {
      ...
      this.OnUpdate(this.easeType != EaseType.none ? EaseManager.EasingFromType(0.0f, 1f, num, this.easeType) : this.animationCurve.Evaluate(num), _isFinished);
    }
