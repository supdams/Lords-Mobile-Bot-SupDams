...
namespace uTools
{
  ...
  public class uTweenPosition : uTweener
  {
    ...
    {
      get => ((Transform) this.cachedRectTransform).localPosition;
      set => ((Transform) this.cachedRectTransform).localPosition = value;
    }
    ...
    public static uTweenPosition Begin(
      GameObject go,
      Vector3 from,
      Vector3 to,
      float duration = 1f,
